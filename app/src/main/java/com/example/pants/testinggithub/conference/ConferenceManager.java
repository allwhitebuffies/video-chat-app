...
//
package com.example.pants.testinggithub.conference;
...
import com.example.pants.testinggithub.conference.Settings.MediaDeviceWrapper;
import com.example.pants.testinggithub.conference.Settings.UserSettings;
import com.example.pants.testinggithub.conference.Settings.UserSettingsManager;
import com.example.pants.testinggithub.conference.VideoCall.CameraWrapper.CameraState;
import com.example.pants.testinggithub.conference.util.CommandQueued;
...
public class ConferenceManager implements IConferenceCoreListener, ILoggerListener
{
	...
	{
		Log.d( Utils.getOoVooTag(), "received OnCameraUnmuted (JAVA) error = " + errorCode + " isCameraMuted = "
				+ mIsCameraMute);
